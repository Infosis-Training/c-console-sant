...
namespace MovieManagement.Controllers
{
    ...
    public class GenresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,IsActive")] Genre genre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,IsActive")] Genre genre)
        {
            if (id != genre.Id)
            {
                return NotFound();
